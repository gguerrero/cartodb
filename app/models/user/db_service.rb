...
module CartoDB
  ...
  module UserModule
    class DBService
      ...
      def drop_organization_user(org_id, is_owner = false, force_schema_deletion = false)
        ...
        Thread.new do
          @user.in_database(as: :superuser) do |database|
            ...
            unless @user.database_schema == SCHEMA_PUBLIC
              ...
              database.run(%{ DROP SCHEMA IF EXISTS "#{@user.database_schema}" #{'CASCADE' if force_schema_deletion == true} })
            end
          end
